...
class StunRequest extends StunMessage {
  ...
  addAttribute(type, ...args) {
    const attribute = attributes.create(type, ...args);
    attribute.setOwner(this);

    /** @type {StunAttribute[]} */
    const attr = this[kAttributes];
  ...
  removeAttribute(type) {
    ...
    const index = attr.findIndex(attribute => attribute.type === type);
    ...
    const next = new Array(attr.length - 1);
