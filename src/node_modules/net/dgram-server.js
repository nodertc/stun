...
module.exports = class StunServer extends Emitter {
   ...
   *
   * @param {StunRequest} req
   * @param {number} port - Remote port.
   * @param {string} address - Remote address.
   * @param {Function} [callback]
   * @returns {bool}
   */
  send(req, port, address, callback) {
    if (this[kClosed]) {
      return false;
    }

    if (!(req instanceof StunRequest)) {
      return false;
    }

    this[kSocket].send(req.toBuffer(), port, address, callback);
    return true;
  }
